...
void student::show_tabular() const
{
	...
	<<c_marks<<setw(4)<<m_marks<<setw(4)<<e_marks<<setw(4)<<cs_marks
...
void modify_student(int); //accept rollnp and update record of binary file
void delete_student(int);//accept rollno and delete selected records from binary file
void class_result(); // display all records in tabular formate from binary file
void result();
void intro();//welcome screen
void entry_menu();
